 ...
 * @author felix
 */
public class JobOrderIFrame extends javax.swing.JInternalFrame {

    private static final long serialVersionUID = 8321625403415667693L;

    /** Creates new form JOsIFrm */
    public JobOrderIFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Job Order's Information");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtGiveName, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void SavePopupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SavePopupActionPerformed
        ...
        try (org.postgresql.core.BaseConnection jdbc = new gov.hrisjo.PGdbLink()) {
            ...
            try (java.sql.Statement stmt = jdbc.createStatement()) {
                ...
                java.util.logging.Logger.getLogger(JobOrderIFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, exs);
            }
    ...
    private void openActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openActionPerformed
        ...
        System.out.println("converted" + selRow);
...
/*
-- Function: humane(character varying, character varying, character varying, character varying)

-- DROP FUNCTION humane(character varying, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION named(
    character varying,
    character varying,
    character varying)
...
$BODY$SELECT 
	...
	CASE WHEN $3 IS NULL THEN '' ELSE $3 END;$BODY$
...
//                }
    ...
    private void lookUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lookUpActionPerformed
        // TODO add your handling code here:
        gov.cont.NamesDialog dialogo = new gov.cont.NamesDialog('J');
    ...
    private void lookposActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lookposActionPerformed
        // TODO add your handling code here:
        RankingDialog dialogo = new RankingDialog();
        dialogo.setLocationRelativeTo(this);
        dialogo.setVisible(true);
        ...
        try (org.postgresql.core.BaseConnection jdbc = new gov.hrisjo.PGdbLink();
                ...
                java.sql.ResultSet rst = stmt.executeQuery(
                    ...
                    "FROM " +
                        "psnl.jobworker " +
                    "WHERE " +
                        "(UPPER(public.named(lastname, firstname, midname)) LIKE '%" + value.toUpperCase() + "%') AND (offcloc IS NULL) " +
                    "ORDER BY " +
                        "lastname, firstname, midname")) {
            javax.swing.table.DefaultTableModel model = (javax.swing.table.DefaultTableModel)tblHuman.getModel();
            model.setNumRows(0);
    ...
    private javax.swing.JTextField txtBankAcct;
