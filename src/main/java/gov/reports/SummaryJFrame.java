 ...
 * @author xiong
 */
public class SummaryJFrame extends javax.swing.JInternalFrame {
    ...
    private void viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewActionPerformed
        // TODO add your handling code here:
        java.io.InputStream reportSource = getClass().getResourceAsStream("/jreport/summary.jasper");
...
//            if (!retVal.toString().matches("\\d+")) return;
            ...
            int from = Integer.parseInt(value, 10),
                toos = Integer.parseInt(balor, 10);
