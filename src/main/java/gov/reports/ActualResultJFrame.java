 ...
 * @author xiong
 */
public class ActualResultJFrame extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cboChoice.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All J.Os", "Executive", "Legislative", "Contractual" }));
...
//            if (!retVal.toString().matches("\\d+")) return;
            ...
            if (value.equals("contract")) {
                params.put("OfficeID", "");
                value = "/jreport/endocount.jasper";
            } else {
                params.put("OfficeID", value);
                value = "/jreport/jobscount.jasper";
            }
            java.io.InputStream reportSource = getClass().getResourceAsStream(value);
            ...
            java.util.logging.Logger.getLogger(ActualResultJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } finally {
