 ...
 * @author felix
 */
public class PGdbLink implements org.postgresql.core.BaseConnection {
...
//    protected static void setServerName(String server) {SERVER = server;}
    ...
    public PGdbLink() throws java.sql.SQLException {
    ...
    public PGdbLink(String database) throws java.sql.SQLException {
        org.postgresql.ds.PGSimpleDataSource pg = new org.postgresql.ds.PGSimpleDataSource();
        pg.setServerNames(SERVER);
        //pg.setPortNumber(port != 0 ? port : 5432);
